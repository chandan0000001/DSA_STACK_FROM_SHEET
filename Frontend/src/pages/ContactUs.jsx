    ...
    <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen md:h-screen bg-[#0a0a0a] text-white md:overflow-hidden">
      ...
      <div className="p-6 md:p-10 flex flex-col justify-between border-b md:border-b-0 md:border-r border-white/[0.07] bg-[#0d0d0d] md:bg-transparent">
        ...
        <div className="flex flex-col gap-2 mb-4 md:mb-0">
          {[
            { label: 'General queries', sub: 'Ask anything about the platform' },
            { label: 'Feedback', sub: 'Help us improve your experience' },
            { label: 'Support', sub: 'Facing issues? We got you' },
          ].map(card => (
            <div
              key={card.label}
      ...
      {!submitted ? (
        <div className="p-6 md:p-10 flex flex-col gap-3 overflow-y-auto">
          <div className="space-y-3 flex-1">
            ...
            <textarea
              className="w-full bg-white/4 border border-white/8 rounded-lg px-3.5 py-3 text-sm text-white placeholder-white/30 outline-none resize-none min-h-45 md:min-h-35 flex-1 focus:border-white/20 transition-colors"
